...
<body>
  ...
  <div class="bk">
    ...
    <table id="sorting">
      ...
      <tr>
        <th>
          <button id="myInput" name="rdb" onclick="myFunction('0')">x</button>
        </th>
        <th>
          <button id="myInput" name="rdb" onclick="myFunction('1')">x</button>
        </th>
        <th>
          <button id="myInput" name="rdb" onclick="myFunction('2')">x</button>
        </th>
        <th>
          <button id="myInput" name="rdb" onclick="myFunction('3')">x</button>
        </th>
      </tr>
    </table>
